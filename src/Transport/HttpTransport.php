...
final class HttpTransport
{
     ...
     */
    public function request(string $requestType, string $apiMethod, array $arHttpRequestOptions = []): array
    {
    ...
    private function createRequest(string $requestType, string $uri, array $requestOptions): RequestInterface
    {
        ...
        if ($requestType === RequestMethodInterface::METHOD_POST && isset($requestOptions['json'])) {
