...
final class SaleItemDto
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'bonus_discount' => $this->bonusDiscount instanceof Money ? MoneyParser::toString(
                $this->bonusDiscount
            ) : null,
            'certificates' => $this->certificates !== null && $this->certificates !== [] ? array_map(
                fn(CertificateDocumentDto $certificateDto): array => $certificateDto->toArray(),
                $this->certificates
            ) : null,
